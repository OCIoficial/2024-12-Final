...
\textbf{Explicación ejemplo:} Como se muestra a continuación, en este ejemplo se
ejecutan cuatro rondas. En la primera ronda se eliminan el participante 3 y 4.
En la segunda se elimina al participante 5. En la tercera se elimina
al participante 6. Finalmente, en la cuarta ronda no hay ningún eliminado y por
lo tanto el proceso termina.
